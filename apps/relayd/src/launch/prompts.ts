...
If part of your task is a separable unit of work (e.g. a schema another module needs), you may delegate it: call ${R.propose_subtask} with a full contract (you are its sender; disjoint allowed_paths; every criterion with a check) and then ${R.await_task} until it is completed before consuming its output.
